...
<head>
    ...
    <meta name="description" content="Browse our quartz countertop inspiration gallery. See stunning kitchen and bathroom projects from Griffin Quartz installations across South Florida.">
...
<body>
    ...
    <section class="hero hero-small">
        <div class="hero-background">
            <img src="images/hotel-lobby-white-marble-reception-palms.webp" alt="Quartz countertop inspiration gallery" loading="eager">
            <div class="hero-overlay"></div>
        </div>
        <div class="hero-content">
            <h1>Inspiration Gallery</h1>
            <p class="hero-description">Browse our quartz countertop projects across South Florida</p>
        </div>
    </section>
