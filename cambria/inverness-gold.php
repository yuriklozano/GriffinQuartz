...
<head>
    ...
    <title>Cambria Inverness Gold Quartz Countertops South Florida | Golden Elegance | Griffin Quartz</title>
...
<body>
                ...
                <ul class="nav-list">
                    <li class="nav-item dropdown"><a href="#" class="nav-link">Cambria Designs</a>
                        <ul class="dropdown-menu">
                            <li><a href="./">All Cambria</a></li>
                            <li><a href="inverness-frost">Inverness Frost</a></li>
                            <li><a href="inverness-gold">Inverness Gold</a></li>
                        </ul>
                    </li>
    ...
    <section class="product-hero">
        <div class="hero-background">
            <img src="../images/cambria-inverness-gold-kitchen.webp" alt="Cambria Inverness Gold quartz countertop" loading="eager">
            <div class="hero-overlay"></div>
        </div>
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="./">Cambria</a> <span>/</span> <span class="current">Inverness Gold</span></nav>
                <span class="product-badge"><i class="bi bi-gem"></i> Inverness Collection</span>
                <h1>Cambria Inverness Gold</h1>
                <p class="product-tagline">Rich Golden Luxury</p>
                <p class="product-description">Inverness Gold displays rich, golden streaks that weave across a pristine white surface, creating a lively and refined visual effect. As the warm companion to the #1 best-selling Inverness Frost, this design brings opulent warmth to any space while maintaining the elegant movement that made the Inverness collection famous.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Inverness Collection</span></div>
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Golden Veining</span></div>
            ...
            <div class="product-swatch-showcase" style="position:relative">
                <div class="main-swatch"><img src="../images/cambria-products/inverness-gold.jpg" alt="Cambria Inverness Gold sample"></div>
                <div class="swatch-label"><h3>Inverness Gold</h3><p>Cambria Inverness Collection</p></div>
            </div>
        </div>
    </section>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Inverness Gold</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Inverness Collection</td></tr>
                        <tr><td>Base Color</td><td>Pristine White</td></tr>
                        <tr><td>Veining</td><td>Rich Golden Streaks</td></tr>
                        <tr><td>Pattern Type</td><td>Flowing Movement</td></tr>
                        ...
                        <tr><td>Price Range</td><td>$85-$130/sq ft installed</td></tr>
                    </table>
                </div>
                <div class="product-applications">
                    <h2>Perfect Applications</h2>
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>White Cabinetry</strong> - Gold veining creates warm contrast</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Luxury Kitchens</strong> - Statement-making elegance</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Gold Hardware</strong> - Coordinates beautifully</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Master Bathrooms</strong> - Spa-like luxury</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Traditional Styles</strong> - Timeless sophistication</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">The Inverness Collection</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">Inverness Gold is the warm companion to Inverness Frost, Cambria's #1 best-selling design. While Frost offers cool, white-on-white elegance, Gold brings warmth with its rich golden streaks. Both share the same beautiful flowing movement that has made the Inverness collection a customer favorite.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="related-designs">
        <div class="container">
            <div class="related-header"><h2>Related Inverness Designs</h2></div>
            <div class="related-grid">
                ...
                <a href="clareanne" class="related-card"><div class="related-card-image"><img src="../images/cambria-products/swatch-clareanne.jpg" alt="Clareanne"></div><div class="related-card-content"><h3>Clareanne</h3></div></a>
                <a href="oakleigh" class="related-card"><div class="related-card-image"><img src="../images/cambria-products/swatch-oakleigh.jpg" alt="Oakleigh"></div><div class="related-card-content"><h3>Oakleigh</h3></div></a>
            </div>
        </div>
    </section>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Inverness Gold Quote</h2>
                <p>Bring golden elegance to your home. Get a free quote for Cambria Inverness Gold.</p>
                <form class="quote-form">
                    ...
                    <div class="form-group"><label for="project">Project Type</label><select id="project"><option>Kitchen</option><option>Bathroom</option><option>Both</option></select></div>
                    <input type="hidden" name="design" value="Cambria Inverness Gold">
