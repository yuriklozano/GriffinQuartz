...
<head>
    ...
    <link rel="canonical" href="https://soflocountertops.com/cambria/montgomery">
...
<body>
    ...
    <section class="product-hero">
        <div class="hero-background">
            <img src="../images/cambria-montgomery-kitchen.webp" alt="Cambria Montgomery quartz countertop" loading="eager">
            <div class="hero-overlay"></div>
        </div>
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="./">Cambria</a> <span>/</span> <span class="current">Montgomery</span></nav>
                <span class="product-badge"><i class="bi bi-star-fill"></i> Top Seller</span>
                <h1>Cambria Montgomery</h1>
                <p class="product-tagline">Elegant Movement & Sophistication</p>
                <p class="product-description">Montgomery is among Cambria's top-selling designs, offering elegant movement and sophisticated appeal. Its balanced blend of neutral tones creates a refined look that enhances any space without overwhelming it. A perennial favorite for homeowners seeking timeless beauty.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Top Seller</span></div>
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Refined Elegance</span></div>
            ...
            <div class="product-swatch-showcase" style="position:relative">
                <div class="main-swatch"><img src="../images/cambria-products/montgomery.jpg" alt="Cambria Montgomery sample"></div>
                <div class="swatch-label"><h3>Montgomery</h3><p>Cambria Signature Collection</p></div>
            </div>
        </div>
    </section>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Montgomery</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Signature Collection</td></tr>
                        <tr><td>Base Color</td><td>Neutral Blend</td></tr>
                        <tr><td>Movement</td><td>Elegant Flowing</td></tr>
                        <tr><td>Pattern Type</td><td>Balanced Sophistication</td></tr>
                ...
                <div class="product-applications">
                    ...
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Traditional Kitchens</strong> - Classic refined elegance</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Transitional Spaces</strong> - Bridges design styles</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Master Bathrooms</strong> - Sophisticated vanity tops</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Statement Islands</strong> - Creates elegant focal points</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Full-Height Backsplash</strong> - Dramatic wall applications</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">Why Choose Montgomery</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">Montgomery consistently ranks among Cambria's top sellers because it delivers sophistication without being overpowering. Its balanced design makes it an excellent choice for homeowners who want elegance that stands the test of time and changing trends.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Montgomery Quote</h2>
                <p>Experience refined elegance. Get a free quote for Cambria Montgomery countertops.</p>
                <form class="quote-form">
                    ...
                    <input type="hidden" name="design" value="Cambria Montgomery">
