...
<head>
    ...
    <title>Cambria Hadley Quartz Countertops South Florida | Classic Marble Look | Griffin Quartz</title>
...
<body>
    ...
    <section class="product-hero">
        <div class="hero-background">
            <img src="../images/cambria-hadley-kitchen.webp" alt="Cambria Hadley quartz countertop" loading="eager">
            <div class="hero-overlay"></div>
        </div>
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="./">Cambria</a> <span>/</span> <span class="current">Hadley</span></nav>
                <span class="product-badge"><i class="bi bi-star-fill"></i> Popular Choice</span>
                <h1>Cambria Hadley</h1>
                <p class="product-tagline">Classic Marble-Look Beauty</p>
                <p class="product-description">Hadley is a beloved marble-look design that has earned its place as one of Cambria's most popular choices. With its timeless appeal and classic veining pattern, Hadley offers the sophisticated look of natural marble with all the benefits of Cambria's superior quartz technology—no sealing, no staining, no worries.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Popular Choice</span></div>
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Marble Look</span></div>
            ...
            <div class="product-swatch-showcase" style="position:relative">
                <div class="main-swatch"><img src="../images/cambria-products/hadley.jpg" alt="Cambria Hadley sample"></div>
                <div class="swatch-label"><h3>Hadley</h3><p>Cambria Marble Look</p></div>
            </div>
        </div>
    </section>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Hadley</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Marble Look Collection</td></tr>
                        <tr><td>Base Color</td><td>Soft White</td></tr>
                        <tr><td>Veining</td><td>Classic Gray</td></tr>
                        <tr><td>Pattern Type</td><td>Timeless Movement</td></tr>
                ...
                <div class="product-applications">
                    ...
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Classic Kitchens</strong> - Timeless elegance</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Master Bathrooms</strong> - Spa-like luxury</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>White Cabinetry</strong> - Perfect coordination</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Traditional Homes</strong> - Classic aesthetic</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Waterfall Islands</strong> - Stunning showcase</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">Why Hadley is Popular</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">Hadley has earned its popularity through its perfect balance of drama and subtlety. The veining is present enough to provide visual interest but not so bold that it overwhelms. It's the design homeowners choose when they want marble elegance without maintenance worries.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="related-designs">
        <div class="container">
            <div class="related-header"><h2>Other Popular Marble-Look Designs</h2></div>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Hadley Quote</h2>
                <p>Bring timeless marble elegance to your home. Get a free quote for Cambria Hadley.</p>
                <form class="quote-form">
                    ...
                    <input type="hidden" name="design" value="Cambria Hadley">
