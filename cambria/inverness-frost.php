...
<head>
    ...
    <title>Cambria Inverness Frost Quartz Countertops South Florida | #1 Best Seller | Griffin Quartz</title>
...
<body>
    ...
    <section class="product-hero">
        <div class="hero-background">
            <img src="../images/cambria-inverness-frost-kitchen.webp" alt="Cambria Inverness Frost quartz countertop" loading="eager">
            <div class="hero-overlay"></div>
        </div>
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="../cambria">Cambria</a> <span>/</span> <span class="current">Inverness Frost</span></nav>
                <span class="product-badge"><i class="bi bi-trophy-fill"></i> #1 Best Seller</span>
                <h1>Cambria Inverness Frost</h1>
                <p class="product-tagline">Cambria's Most Popular Design</p>
                <p class="product-description">Inverness Frost is currently Cambria's best-selling design, featuring intricate off-white veining that dances across a cool white backdrop. This design offers the perfect balance of visual interest and understated elegance that appeals to a wide range of tastes.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>#1 Best Seller</span></div>
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Subtle Elegance</span></div>
            ...
            <div class="product-swatch-showcase" style="position:relative">
                <div class="main-swatch"><img src="../images/cambria-products/inverness-frost.jpg" alt="Cambria Inverness Frost sample"></div>
                <div class="swatch-label"><h3>Inverness Frost</h3><p>Cambria Signature Series</p></div>
            </div>
        </div>
    </section>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Inverness Frost</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Signature Series</td></tr>
                        <tr><td>Base Color</td><td>Cool White</td></tr>
                        <tr><td>Veining</td><td>Intricate Off-White</td></tr>
                        <tr><td>Pattern Type</td><td>Subtle Movement</td></tr>
                ...
                <div class="product-applications">
                    ...
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Any Kitchen Style</strong> - Universal appeal suits all designs</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Bathroom Vanities</strong> - Clean, fresh look for baths</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Resale Homes</strong> - Broad appeal maximizes value</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Rental Properties</strong> - Neutral design suits all tenants</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Commercial Spaces</strong> - Professional, clean aesthetic</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">Why It's #1</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">Inverness Frost strikes the perfect balance - it has enough visual interest to be interesting without being overwhelming. The subtle veining adds depth and character while remaining versatile enough to work with virtually any cabinet color, backsplash, or decor style.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="related-designs">
        <div class="container">
            <div class="related-header"><h2>Other Popular Designs</h2></div>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Inverness Frost Quote</h2>
                <p>Join the countless homeowners who chose Cambria's best-selling design. Get your free quote today.</p>
                <form class="quote-form">
                    ...
                    <input type="hidden" name="design" value="Cambria Inverness Frost">
