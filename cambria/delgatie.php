...
<head>
    ...
    <title>Cambria Delgatie Quartz Countertops South Florida | Warm Neutral Elegance | Griffin Quartz</title>
...
<body>
                ...
                <ul class="nav-list">
                    <li class="nav-item dropdown"><a href="#" class="nav-link">Cambria Designs</a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="delgatie">Delgatie</a></li>
                        </ul>
                    </li>
    ...
    <section class="product-hero">
        <div class="hero-background">
            <img src="../images/cambria-delgatie-kitchen.webp" alt="Cambria Delgatie quartz countertop" loading="eager">
            <div class="hero-overlay"></div>
        </div>
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="./">Cambria</a> <span>/</span> <span class="current">Delgatie</span></nav>
                <span class="product-badge"><i class="bi bi-sun"></i> Warm Neutral</span>
                <h1>Cambria Delgatie</h1>
                <p class="product-tagline">Serene White-on-White Elegance</p>
                <p class="product-description">Delgatie exudes a serene elegance with a gentle white-on-white hue complemented by inviting warm vein patterns. Its understated charm harmonizes beautifully with any setting, blending effortlessly while maintaining its own delightful personality. Available in high gloss and Cambria Matte finishes.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Warm Undertones</span></div>
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Serene Elegance</span></div>
            ...
            <div class="product-swatch-showcase" style="position:relative">
                <div class="main-swatch"><img src="../images/cambria-products/delgatie.jpg" alt="Cambria Delgatie sample"></div>
                <div class="swatch-label"><h3>Delgatie</h3><p>Cambria Warm Neutrals</p></div>
            </div>
        </div>
    </section>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Delgatie</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Warm Neutrals</td></tr>
                        <tr><td>Base Color</td><td>White-on-White</td></tr>
                        <tr><td>Veining</td><td>Warm Cross Veining</td></tr>
                        <tr><td>Pattern Type</td><td>Subtle, Understated</td></tr>
                ...
                <div class="product-applications">
                    ...
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Soft White Kitchens</strong> - Warm complement to white cabinets</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Cream Cabinetry</strong> - Seamless warm coordination</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Bathroom Vanities</strong> - Creates spa-like serenity</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Traditional Homes</strong> - Classic understated elegance</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Coastal Designs</strong> - Soft beachy aesthetic</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">2025 Trend</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">Warm neutrals like Delgatie are trending strongly in 2025. Beige, taupe, and soft grey tones bring natural elegance to kitchens and bathrooms, creating inviting spaces that feel both sophisticated and welcoming.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Delgatie Quote</h2>
                <p>Embrace serene elegance. Get a free quote for Cambria Delgatie countertops.</p>
                <form class="quote-form">
                    ...
                    <input type="hidden" name="design" value="Cambria Delgatie">
