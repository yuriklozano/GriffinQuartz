...
<head>
    ...
    <title>Cambria Berwyn Quartz Countertops South Florida | Versatile Granite-Look | Griffin Quartz</title>
...
<body>
    ...
    <section class="product-hero">
        <div class="hero-background">
            <img src="../images/cambria-berwyn-kitchen.webp" alt="Cambria Berwyn quartz countertop" loading="eager">
            <div class="hero-overlay"></div>
        </div>
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="./">Cambria</a> <span>/</span> <span class="current">Berwyn</span></nav>
                <span class="product-badge"><i class="bi bi-stars"></i> Designer Go-To</span>
                <h1>Cambria Berwyn</h1>
                <p class="product-tagline">The Ultimate Versatile Choice</p>
                <p class="product-description">Berwyn is a swirly, granite-like design featuring whites, ivories, and creams with subtle gray veins and hints of gold and silver throughout. With subtle sparkle visible when looking straight at the surface, Berwyn is the designer's go-to choice when clients are unsure - it goes with everything.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Subtle Sparkle</span></div>
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Universal Appeal</span></div>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Berwyn</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Classic Collection</td></tr>
                        <tr><td>Base Colors</td><td>White, Ivory, Cream</td></tr>
                        <tr><td>Accents</td><td>Gray, Gold, Silver</td></tr>
                        <tr><td>Pattern Type</td><td>Swirly / Granite-Like</td></tr>
                        <tr><td>Special Feature</td><td>Subtle Sparkle</td></tr>
                ...
                <div class="product-applications">
                    ...
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>White Cabinets</strong> - Beautiful warm complement</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Cream Cabinets</strong> - Seamless coordination</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Hickory/Wood Cabinets</strong> - Natural warmth pairing</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Traditional Kitchens</strong> - Classic granite alternative</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Transitional Spaces</strong> - Bridges warm and cool tones</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Beach/Coastal Homes</strong> - Popular for vacation properties</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">Designer Quote</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">"My go-to when clients are unsure is Berwyn - it seems to go with a lot of different finishes." Berwyn uniquely unifies both warm and cool tones, making it perfect for clients who want flexibility.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Berwyn Quote</h2>
                <p>Can't decide? Berwyn works with everything. Get your free quote today.</p>
                <form class="quote-form">
                    ...
                    <input type="hidden" name="design" value="Cambria Berwyn">
