...
<head>
    ...
    <title>Cambria Portrush Quartz Countertops South Florida | Bold Veining with Gold | Griffin Quartz</title>
...
<body>
    ...
    <section class="product-hero">
        <div class="hero-background">
            <img src="../images/cambria-portrush-kitchen.webp" alt="Cambria Portrush quartz countertop" loading="eager">
            <div class="hero-overlay"></div>
        </div>
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="../cambria">Cambria</a> <span>/</span> <span class="current">Portrush</span></nav>
                <span class="product-badge"><i class="bi bi-stars"></i> 2020 Top Seller</span>
                <h1>Cambria Portrush</h1>
                <p class="product-tagline">Bold Drama with Golden Accents</p>
                <p class="product-description">Portrush was one of 20 designs Cambria released in 2020, and it quickly became the most popular new design by far. It features a creamy white base crisscrossed with bold navy, gray and black veins, accompanied by fine spun filaments of gleaming gold flakes.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Gold Flake Accents</span></div>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Portrush</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Luxury Series</td></tr>
                        <tr><td>Base Color</td><td>Creamy White</td></tr>
                        <tr><td>Veining</td><td>Bold Navy, Gray, Black</td></tr>
                        <tr><td>Accents</td><td>Gold Flakes</td></tr>
                        <tr><td>Pattern Type</td><td>Bold, Dramatic</td></tr>
                        <tr><td>Finish Options</td><td>High Gloss, Matte</td></tr>
                        <tr><td>Slab Size</td><td>132" x 65.5"</td></tr>
                        <tr><td>Origin</td><td>Made in USA</td></tr>
                        <tr><td>Warranty</td><td>Full Lifetime</td></tr>
                        <tr><td>Price Range</td><td>$80-$130/sq ft installed</td></tr>
                    </table>
                </div>
                <div class="product-applications">
                    <h2>Perfect Applications</h2>
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Statement Kitchens</strong> - Bold veining creates a stunning focal point</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Waterfall Islands</strong> - Gold flakes shimmer beautifully on edges</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Luxury Homes</strong> - High-end aesthetic for upscale spaces</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Full Backsplashes</strong> - Dramatic impact at full scale</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Master Bathrooms</strong> - Creates spa-like luxury</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">Design Tip</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">Portrush pairs beautifully with navy blue or charcoal cabinets to pull out the veining colors. Gold or brass hardware complements the gold flakes perfectly. For a more subtle look, pair with white cabinets to let the countertop be the star.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Portrush Quote</h2>
                <p>Ready to make a bold statement? Get a free quote for Cambria Portrush.</p>
                <form class="quote-form">
                    ...
                    <input type="hidden" name="design" value="Cambria Portrush">
