...
<head>
    ...
    <title>Cambria Blackpool Quartz Countertops South Florida | Deep Ebony Matte | Griffin Quartz</title>
...
<body>
                ...
                <ul class="nav-list">
                    <li class="nav-item dropdown"><a href="#" class="nav-link">Cambria Designs</a>
                        <ul class="dropdown-menu">
                            <li><a href="../cambria">All Cambria</a></li>
    ...
    <section class="product-hero">
        <div class="hero-background">
            <img src="../images/cambria-blackpool-kitchen.webp" alt="Cambria Blackpool quartz countertop" loading="eager">
            <div class="hero-overlay"></div>
        </div>
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="../cambria">Cambria</a> <span>/</span> <span class="current">Blackpool</span></nav>
                <span class="product-badge"><i class="bi bi-moon-stars-fill"></i> Luxury Series</span>
                <h1>Cambria Blackpool</h1>
                <p class="product-tagline">Commanding Presence</p>
                <p class="product-description">Vast and commanding, Blackpool is darkest ebony with a stealthy silken Cambria Matte finish that absorbs light like a starless night over the Irish Sea. This powerful design adds depth and allure to any space with its captivating, light-absorbing quality.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Cambria Matte Finish</span></div>
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Rich Ebony Color</span></div>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Blackpool</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Luxury Series</td></tr>
                        <tr><td>Color</td><td>Deep Ebony Black</td></tr>
                        <tr><td>Pattern</td><td>Solid</td></tr>
                        <tr><td>Finish</td><td>Cambria Matte (Signature)</td></tr>
                        <tr><td>Slab Size</td><td>132" x 65.5"</td></tr>
                        <tr><td>Origin</td><td>Made in USA</td></tr>
                        <tr><td>Warranty</td><td>Full Lifetime</td></tr>
                        <tr><td>Price Range</td><td>$85-$135/sq ft installed</td></tr>
                    </table>
                </div>
                <div class="product-applications">
                    <h2>Perfect Applications</h2>
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Modern Kitchens</strong> - Dramatic contrast with light cabinetry</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Waterfall Islands</strong> - Sleek, contemporary statement piece</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Bathroom Vanities</strong> - Spa-like sophistication</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Backsplashes</strong> - Bold accent wall effect</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Commercial Spaces</strong> - Hotels, restaurants, offices</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">Care Tip</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">Black quartz surfaces do tend to show fingerprints more than lighter colors. The good news is that cleaning is a breeze - simply wipe with warm water and mild soap. The Cambria Matte finish also helps minimize the appearance of smudges compared to high gloss finishes.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Blackpool Quote</h2>
                <p>Ready to make a bold, dark statement? Get a free quote for Cambria Blackpool.</p>
                <form class="quote-form">
                    ...
                    <div class="form-group"><label for="project">Project Type</label><select id="project"><option>Kitchen</option><option>Bathroom</option><option>Both</option><option>Commercial</option></select></div>
                    <input type="hidden" name="design" value="Cambria Blackpool">
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-grid">
                <div class="footer-col"><h4>Showroom</h4><p>1021 S Rogers Cir #18<br>Boca Raton, FL 33487</p></div>
                <div class="footer-col"><h4>Contact</h4><p><a href="tel:7203241436">(720) 324-1436</a></p></div>
            </div>
            <div class="footer-bottom"><p>&copy; 2025 Griffin Quartz</p></div>
        </div>
    </footer>
