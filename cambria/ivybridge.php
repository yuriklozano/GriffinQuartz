...
<head>
    ...
    <title>Cambria Ivybridge Quartz Countertops South Florida | Earthy Green Tones | Griffin Quartz</title>
...
<body>
                ...
                <ul class="nav-list">
                    <li class="nav-item dropdown"><a href="#" class="nav-link">Cambria Designs</a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="ivybridge">Ivybridge</a></li>
                        </ul>
                    </li>
    ...
    <section class="product-hero">
        <div class="hero-background">
            <img src="../images/cambria-ivybridge-kitchen.webp" alt="Cambria Ivybridge quartz countertop" loading="eager">
            <div class="hero-overlay"></div>
        </div>
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="./">Cambria</a> <span>/</span> <span class="current">Ivybridge</span></nav>
                <span class="product-badge"><i class="bi bi-tree-fill"></i> Nature-Inspired</span>
                <h1>Cambria Ivybridge</h1>
                <p class="product-tagline">Earthy Green Elegance</p>
                <p class="product-description">Ivybridge draws inspiration from nature with its beautiful earthy green tones that bring organic warmth to any space. This 2025 trending design pairs beautifully with wood accents, natural textures, and organic materials, making it perfect for biophilic design that connects your home to the natural world.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Nature-Inspired</span></div>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Ivybridge</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Nature Collection</td></tr>
                        <tr><td>Base Color</td><td>Earthy Green</td></tr>
                        <tr><td>Undertones</td><td>Natural, Organic</td></tr>
                        <tr><td>Pattern Type</td><td>Nature-Inspired Movement</td></tr>
                ...
                <div class="product-applications">
                    ...
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Wood Cabinetry</strong> - Natural pairing with walnut, oak, or maple</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Biophilic Designs</strong> - Connects interior to nature</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Organic Modern</strong> - Perfect for natural luxury</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Indoor-Outdoor Spaces</strong> - Flows with exterior views</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Spa Bathrooms</strong> - Creates tranquil retreat</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">2025 Green Trend</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">Earthy greens are one of the standout trends for 2025-2026. Ivybridge draws inspiration from nature and pairs beautifully with wood accents or organic textures, making it ideal for homeowners seeking to bring the outdoors in.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Ivybridge Quote</h2>
                <p>Bring nature's beauty indoors. Get a free quote for Cambria Ivybridge.</p>
                <form class="quote-form">
                    ...
                    <input type="hidden" name="design" value="Cambria Ivybridge">
