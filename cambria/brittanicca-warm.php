...
<body>
                ...
                <ul class="nav-list">
                    <li class="nav-item dropdown"><a href="#" class="nav-link">Cambria Designs</a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="brittanicca-warm">Brittanicca Warm</a></li>
                        </ul>
                    </li>
    ...
    <section class="product-hero">
        <div class="hero-background">
            <img src="../images/cambria-brittanicca-warm-kitchen.webp" alt="Cambria Brittanicca Warm quartz countertop" loading="eager">
            <div class="hero-overlay"></div>
        </div>
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="./">Cambria</a> <span>/</span> <span class="current">Brittanicca Warm</span></nav>
                <span class="product-badge"><i class="bi bi-fire"></i> Brittanicca Collection</span>
                <h1>Cambria Brittanicca Warm</h1>
                <p class="product-tagline">Cozy Marble-Look Elegance</p>
                <p class="product-description">Brittanicca Warm brings the beloved Brittanicca design into warmer territory with soft cream undertones and cozy veining that creates an inviting atmosphere. This design offers all the dramatic beauty of the original Brittanicca but with a warmer palette that coordinates beautifully with today's trending warm neutral interiors.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Brittanicca Family</span></div>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Brittanicca Warm</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Brittanicca Collection</td></tr>
                        <tr><td>Base Color</td><td>Warm Cream White</td></tr>
                        <tr><td>Veining</td><td>Warm Gray with Taupe</td></tr>
                        <tr><td>Pattern Type</td><td>Dramatic Flowing Movement</td></tr>
                        ...
                        <tr><td>Price Range</td><td>$85-$140/sq ft installed</td></tr>
                    </table>
                </div>
                <div class="product-applications">
                    <h2>Perfect Applications</h2>
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Warm-Toned Kitchens</strong> - Coordinates with cream cabinetry</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Wood Cabinets</strong> - Beautiful natural pairing</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Traditional Styles</strong> - Timeless warm elegance</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Transitional Design</strong> - Bridges classic and modern</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Cozy Spaces</strong> - Inviting, welcoming feel</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">The Brittanicca Family</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">The Brittanicca collection includes the original cool-toned Brittanicca, the golden Brittanicca Gold, and this warm-toned Brittanicca Warm. Each shares the same stunning dramatic veining but with different undertones to match various design preferences. This allows you to get the iconic Brittanicca look in the temperature that best suits your space.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Brittanicca Warm Quote</h2>
                <p>Bring cozy marble elegance to your home. Get a free quote for Cambria Brittanicca Warm.</p>
                <form class="quote-form">
                    ...
                    <input type="hidden" name="design" value="Cambria Brittanicca Warm">
