...
<head>
    ...
    <title>Cambria Sutherland Quartz Countertops South Florida | Calming Blue Tones | Griffin Quartz</title>
    ...
    <section class="product-hero">
        ...
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="./">Cambria</a> <span>/</span> <span class="current">Sutherland</span></nav>
                <span class="product-badge"><i class="bi bi-water"></i> Calming Blues</span>
                <h1>Cambria Sutherland</h1>
                <p class="product-tagline">Tranquil Blue Serenity</p>
                <p class="product-description">Sutherland brings calming blue tones to your space, creating a serene and peaceful atmosphere. This 2025 trending design draws inspiration from coastal waters and pairs beautifully with wood accents, natural textures, and white cabinetry for a refreshing, spa-like environment.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Calming Tones</span></div>
            ...
            <div class="product-swatch-showcase" style="position:relative">
                <div class="main-swatch"><img src="../images/swatch-sutherland-large.webp" alt="Cambria Sutherland sample"></div>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Sutherland</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Coastal Collection</td></tr>
                        <tr><td>Base Color</td><td>Calming Blue</td></tr>
                        <tr><td>Undertones</td><td>Serene, Coastal</td></tr>
                        <tr><td>Pattern Type</td><td>Tranquil Movement</td></tr>
                ...
                <div class="product-applications">
                    ...
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Coastal Homes</strong> - Perfect for beachside living</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>White Cabinetry</strong> - Fresh, crisp contrast</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Spa Bathrooms</strong> - Creates relaxing retreat</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Wood Accents</strong> - Beautiful natural pairing</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Open Kitchens</strong> - Brings calm to gathering spaces</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">2025 Blue Trend</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">Calming blues are a standout trend for 2025-2026. Sutherland draws inspiration from nature and pairs beautifully with wood accents or organic textures. Perfect for South Florida's coastal lifestyle and homes seeking a connection to the sea.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="related-designs">
        <div class="container">
            ...
            <div class="related-grid">
                <a href="ivybridge" class="related-card"><div class="related-card-image"><img src="../images/swatch-ivybridge.webp" alt="Ivybridge"></div><div class="related-card-content"><h3>Ivybridge</h3></div></a>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Sutherland Quote</h2>
                <p>Bring coastal serenity to your home. Get a free quote for Cambria Sutherland.</p>
                <form class="quote-form">
                    ...
                    <input type="hidden" name="design" value="Cambria Sutherland">
