                ...
                <ul class="nav-list">
                    <li class="nav-item dropdown"><a href="#" class="nav-link">Cambria Designs</a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="skara-brae">Skara Brae</a></li>
                        </ul>
                    </li>
    ...
    <section class="product-hero">
        ...
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="./">Cambria</a> <span>/</span> <span class="current">Skara Brae</span></nav>
                <span class="product-badge"><i class="bi bi-lightning-fill"></i> Bold Statement</span>
                <h1>Cambria Skara Brae</h1>
                <p class="product-tagline">Dramatic Movement & Depth</p>
                <p class="product-description">Skara Brae is a bold, extraordinary design set against a bone-white marbled backdrop. Large translucent taupe and olive-green veins flow in dynamic patterns, mostly horizontal, with delicate white and black tributaries adding subtle elegance. This quartz is sure to bring dramatic movement to any room.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Bold Movement</span></div>
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Unique Character</span></div>
            ...
            <div class="product-swatch-showcase" style="position:relative">
                <div class="main-swatch"><img src="../images/swatch-skara-brae-large.webp" alt="Cambria Skara Brae sample"></div>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Skara Brae</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Signature Collection</td></tr>
                        <tr><td>Base Color</td><td>Bone White / Marbled</td></tr>
                        <tr><td>Veining</td><td>Translucent Taupe & Olive Green</td></tr>
                        <tr><td>Pattern Type</td><td>Bold Horizontal Flow</td></tr>
                        <tr><td>Accents</td><td>White & Black Tributaries</td></tr>
                ...
                <div class="product-applications">
                    ...
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Statement Islands</strong> - The bold veining creates stunning focal points</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Light Gray Cabinets</strong> - Stunning pairing with soft grays</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Waterfall Edges</strong> - Dramatic flow over island edges</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Modern Kitchens</strong> - Contemporary statement piece</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Full-Height Backsplash</strong> - Creates wall art effect</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">Design Inspiration</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">Named after a prehistoric village in Scotland, Skara Brae captures the raw beauty of ancient landscapes. The dynamic veining patterns evoke the movement of water and time, making each slab a one-of-a-kind piece of functional art.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Skara Brae Quote</h2>
                <p>Ready to make a bold statement? Get a free quote for Cambria Skara Brae countertops.</p>
                <form class="quote-form">
                    ...
                    <input type="hidden" name="design" value="Cambria Skara Brae">
