...
<head>
    ...
    <title>Cambria Lakedale Quartz Countertops South Florida | #3 Best Seller | Griffin Quartz</title>
...
<body>
                ...
                <ul class="nav-list">
                    <li class="nav-item dropdown"><a href="#" class="nav-link">Cambria Designs</a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="lakedale">Lakedale</a></li>
                        </ul>
                    </li>
    ...
    <section class="product-hero">
        <div class="hero-background">
            <img src="../images/cambria-lakedale-kitchen.webp" alt="Cambria Lakedale quartz countertop" loading="eager">
            <div class="hero-overlay"></div>
        </div>
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="./">Cambria</a> <span>/</span> <span class="current">Lakedale</span></nav>
                <span class="product-badge"><i class="bi bi-trophy-fill"></i> #3 Best Seller</span>
                <h1>Cambria Lakedale</h1>
                <p class="product-tagline">Warm & Cool in Perfect Harmony</p>
                <p class="product-description">Lakedale offers a stunning blend of warm tan and cool gray hues flowing across a bright white marbled canvas, accented by charcoal speckles. This design ranks as Cambria's third best-selling color, beloved for its perfect balance of warmth and coolness that works with virtually any design style.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>#3 Best Seller</span></div>
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Warm-Cool Balance</span></div>
            ...
            <div class="product-swatch-showcase" style="position:relative">
                <div class="main-swatch"><img src="../images/swatch-lakedale-large.webp" alt="Cambria Lakedale sample"></div>
                <div class="swatch-label"><h3>Lakedale</h3><p>Cambria Signature Collection</p></div>
            </div>
        </div>
    </section>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Lakedale</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Signature Collection</td></tr>
                        <tr><td>Base Color</td><td>Bright White Marbled</td></tr>
                        <tr><td>Veining</td><td>Warm Tan & Cool Gray</td></tr>
                        <tr><td>Accents</td><td>Charcoal Speckles</td></tr>
                ...
                <div class="product-applications">
                    ...
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Any Cabinet Color</strong> - Works with warm or cool tones</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Mixed Metal Fixtures</strong> - Complements gold, chrome, or both</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Transitional Kitchens</strong> - Perfect style bridge</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Bathroom Vanities</strong> - Universal appeal for bathrooms</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Rental/Resale Properties</strong> - Appeals to all buyers</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">Why It's #3</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">Lakedale's unique ability to bridge warm and cool color palettes makes it incredibly versatile. Whether your home leans warm with golden tones or cool with silvers and grays, Lakedale ties it all together beautifully.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="related-designs">
        <div class="container">
            ...
            <div class="related-grid">
                <a href="inverness-frost" class="related-card"><div class="related-card-image"><img src="../images/swatch-inverness-frost.webp" alt="Inverness Frost"></div><div class="related-card-content"><h3>Inverness Frost (#1)</h3></div></a>
                <a href="brittanicca-gold" class="related-card"><div class="related-card-image"><img src="../images/swatch-brittanicca-gold.webp" alt="Brittanicca Gold"></div><div class="related-card-content"><h3>Brittanicca Gold (#2)</h3></div></a>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Lakedale Quote</h2>
                <p>Join the thousands who've chosen this best-selling design. Get a free quote today.</p>
                <form class="quote-form">
                    ...
                    <input type="hidden" name="design" value="Cambria Lakedale">
