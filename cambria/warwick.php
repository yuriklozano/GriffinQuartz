...
<head>
    ...
    <title>Cambria Warwick Quartz Countertops South Florida | Classic Traditional | Griffin Quartz</title>
    ...
    <section class="product-hero">
        ...
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="./">Cambria</a> <span>/</span> <span class="current">Warwick</span></nav>
                <span class="product-badge"><i class="bi bi-columns-gap"></i> Classic Series</span>
                <h1>Cambria Warwick</h1>
                <p class="product-tagline">Traditional Elegance Refined</p>
                <p class="product-description">Warwick is a newer quartz countertop from Cambria's Classic Series, featuring slightly more traditional veining with a combination of speckles and flecks amid an ocean of veining. This design offers timeless appeal for homeowners who appreciate classic patterns with refined sophistication.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Classic Series</span></div>
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Traditional Style</span></div>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Warwick</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Classic Series</td></tr>
                        <tr><td>Base Color</td><td>Neutral Cream/White</td></tr>
                        <tr><td>Veining</td><td>Traditional with Speckles</td></tr>
                        <tr><td>Pattern Type</td><td>Classic Movement</td></tr>
                ...
                <div class="product-applications">
                    ...
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Traditional Kitchens</strong> - Timeless classic appeal</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Cream Cabinetry</strong> - Harmonious neutral coordination</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Colonial Homes</strong> - Period-appropriate elegance</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Bathroom Vanities</strong> - Classic refinement</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Resale Value</strong> - Broadly appealing design</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">Classic Series Appeal</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">Warwick is part of Cambria's Classic Series, designed for homeowners who appreciate traditional patterns. Its combination of speckles, flecks, and veining creates depth and interest while maintaining a timeless aesthetic that never goes out of style.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Warwick Quote</h2>
                <p>Embrace timeless traditional elegance. Get a free quote for Cambria Warwick.</p>
                <form class="quote-form">
                    ...
                    <input type="hidden" name="design" value="Cambria Warwick">
