...
<head>
    ...
    <title>Cambria Rose Bay Quartz Countertops South Florida | Soft Blush Tones | Griffin Quartz</title>
                ...
                <ul class="nav-list">
                    <li class="nav-item dropdown"><a href="#" class="nav-link">Cambria Designs</a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="rose-bay">Rose Bay</a></li>
                        </ul>
                    </li>
    ...
    <section class="product-hero">
        ...
        <div class="product-hero-container">
            <div class="product-hero-content">
                <nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <a href="./">Cambria</a> <span>/</span> <span class="current">Rose Bay</span></nav>
                <span class="product-badge"><i class="bi bi-flower1"></i> Unique Design</span>
                <h1>Cambria Rose Bay</h1>
                <p class="product-tagline">Distinctive Blush Elegance</p>
                <p class="product-description">Rose Bay offers a truly unique aesthetic with soft pink and blush undertones that set it apart from traditional quartz designs. This distinctive design brings warmth and feminine elegance to spaces, creating a one-of-a-kind look that's perfect for those who want something special and unexpected.</p>
                <div class="product-features-mini">
                    ...
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Unique Design</span></div>
                    <div class="product-feature-mini"><i class="bi bi-check-circle-fill"></i><span>Blush Undertones</span></div>
            ...
            <div class="product-details-grid">
                <div class="product-specs">
                    ...
                    <table class="specs-table">
                        <tr><td>Design Name</td><td>Rose Bay</td></tr>
                        <tr><td>Brand</td><td>Cambria</td></tr>
                        <tr><td>Collection</td><td>Unique Collection</td></tr>
                        <tr><td>Base Color</td><td>Soft White with Blush</td></tr>
                        <tr><td>Undertones</td><td>Pink/Blush</td></tr>
                        <tr><td>Pattern Type</td><td>Subtle Warm Movement</td></tr>
                        ...
                        <tr><td>Price Range</td><td>$80-$125/sq ft installed</td></tr>
                    </table>
                </div>
                <div class="product-applications">
                    <h2>Perfect Applications</h2>
                    <ul class="applications-list">
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Master Bathrooms</strong> - Spa-like feminine retreat</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Rose Gold Hardware</strong> - Perfect coordination</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>White Cabinetry</strong> - Subtle blush accent</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Glam Kitchens</strong> - Unique focal point</div></li>
                        <li><i class="bi bi-check-circle-fill"></i><div><strong>Boutique Spaces</strong> - Distinctive commercial appeal</div></li>
                    </ul>
                    <div style="margin-top:2rem;padding:1.5rem;background:var(--color-light);border-radius:8px">
                        <h3 style="font-size:1rem;color:var(--color-primary);margin-bottom:.5rem">One-of-a-Kind Appeal</h3>
                        <p style="font-size:.9375rem;color:var(--color-gray);line-height:1.6;margin:0">Rose Bay is for those who want their space to stand out. The soft blush undertones are subtle enough to be elegant but distinctive enough to make a statement. Pair with rose gold or brass hardware and soft white cabinetry for a cohesive, luxurious look that's uniquely yours.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="quote-section" id="quote">
        <div class="container">
            <div class="quote-container">
                <h2>Get Your Rose Bay Quote</h2>
                <p>Create something uniquely beautiful. Get a free quote for Cambria Rose Bay.</p>
                <form class="quote-form">
                    ...
                    <input type="hidden" name="design" value="Cambria Rose Bay">
