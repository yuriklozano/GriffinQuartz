...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "Service",
        "serviceType": "Medical Clinic Quartz Countertop Installation",
        "provider": {
            "@type": "LocalBusiness",
            "name": "Griffin Quartz",
        ...
        "description": "Hygienic quartz countertop installation for medical clinics, dental offices, and healthcare facilities."
    }
    </script>
...
<body>
    ...
    <nav class="breadcrumb" aria-label="Breadcrumb">
        <ol class="breadcrumb-list">
            ...
            <li><span class="separator">/</span></li>
            <li><span class="current">Medical Clinics</span></li>
        </ol>
    </nav>

    <section class="hero">
        <div class="hero-bg">
            <img src="images/commercial-retail-marble-counter.webp" alt="Medical clinic quartz countertops South Florida">
        </div>
    ...
    <section class="applications-section">
        <div class="container">
            <h2 class="section-title" style="text-align: center;">Medical & Dental Quartz Applications</h2>
            <p class="section-description" style="text-align: center; max-width: 700px; margin: 0 auto;">Purpose-built surfaces for every area of your healthcare facility.</p>

            <div class="applications-grid">
                <div class="application-card">
                    <i class="bi bi-clipboard2-pulse"></i>
                    <h4>Exam Rooms</h4>
                    <p>Easy-to-sanitize surfaces for patient examination areas and treatment rooms.</p>
                </div>
                <div class="application-card">
                    <i class="bi bi-emoji-smile"></i>
                    <h4>Dental Operatories</h4>
                    <p>Durable counters for dental chairs, instrument storage, and sterilization areas.</p>
                </div>
                <div class="application-card">
                    <i class="bi bi-eyedropper"></i>
                    <h4>Lab & Testing</h4>
                    <p>Chemical-resistant surfaces for laboratory work and specimen processing.</p>
                </div>
                <div class="application-card">
                    <i class="bi bi-door-open"></i>
                    <h4>Reception Areas</h4>
                    <p>Welcoming front desk surfaces that maintain a clean, professional appearance.</p>
                </div>
                <div class="application-card">
                    <i class="bi bi-prescription2"></i>
                    <h4>Pharmacy Counters</h4>
                    <p>Dispensing and consultation counters for in-house pharmacies.</p>
                </div>
                <div class="application-card">
                    <i class="bi bi-bandaid"></i>
                    <h4>Nurse Stations</h4>
                    <p>Functional work surfaces for charting, medication prep, and patient monitoring.</p>
                </div>
                <div class="application-card">
                    <i class="bi bi-droplet"></i>
                    <h4>Restroom Vanities</h4>
                    <p>Hygienic vanity tops for patient and staff restrooms.</p>
                </div>
                <div class="application-card">
                    <i class="bi bi-cup-hot"></i>
                    <h4>Break Rooms</h4>
                    <p>Staff lounge countertops that withstand daily use and easy cleaning.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="benefits-grid">
                <div class="benefits-content">
                    <h3>Why Quartz for Healthcare?</h3>
                    <p>Medical environments require surfaces that support infection control while maintaining a professional, calming atmosphere. Quartz countertops deliver exceptional hygiene and durability.</p>
                    <ul class="benefits-list">
                        <li><i class="bi bi-check-circle-fill"></i> <span><strong>Non-Porous Surface:</strong> Won't harbor bacteria, viruses, or pathogens that can hide in porous materials.</span></li>
                        <li><i class="bi bi-check-circle-fill"></i> <span><strong>Chemical Resistant:</strong> Withstands disinfectants, sanitizers, and cleaning chemicals without damage.</span></li>
                        <li><i class="bi bi-check-circle-fill"></i> <span><strong>Easy Sterilization:</strong> Smooth surface allows for thorough cleaning between patients.</span></li>
                        <li><i class="bi bi-check-circle-fill"></i> <span><strong>Stain Resistant:</strong> Blood, iodine, and other medical stains wipe clean without marking.</span></li>
                        <li><i class="bi bi-check-circle-fill"></i> <span><strong>Durable:</strong> Resists chips, cracks, and damage from medical equipment.</span></li>
                        <li><i class="bi bi-check-circle-fill"></i> <span><strong>Professional Aesthetics:</strong> Creates a clean, modern environment that reassures patients.</span></li>
                    </ul>
                </div>
                <div class="benefits-image">
                    <img src="images/commercial-office-lobby-modern.webp" alt="Medical office reception quartz countertops">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="why-section">
        <div class="container">
            <h2 class="section-title" style="text-align: center;">Why Healthcare Facilities Choose Griffin Quartz</h2>
            <div class="why-grid">
                <div class="why-card">
                    <i class="bi bi-shield-check"></i>
                    <h3>Healthcare Experience</h3>
                    <p>Extensive experience with medical offices, dental practices, urgent care centers, and specialty clinics.</p>
                </div>
                <div class="why-card">
                    <i class="bi bi-calendar-check"></i>
                    <h3>Flexible Scheduling</h3>
                    <p>After-hours and weekend installation to avoid disrupting patient care and appointments.</p>
                </div>
                <div class="why-card">
                    <i class="bi bi-clock-history"></i>
                    <h3>Fast Turnaround</h3>
                    <p>Minimize practice downtime with efficient templating, fabrication, and installation.</p>
                </div>
                <div class="why-card">
                    <i class="bi bi-file-earmark-check"></i>
                    <h3>Compliance Aware</h3>
                    <p>Understanding of healthcare facility requirements and building codes.</p>
                </div>
                <div class="why-card">
                    <i class="bi bi-broom"></i>
                    <h3>Clean Installation</h3>
                    <p>Dust containment and thorough cleanup to maintain your sterile environment.</p>
                </div>
                <div class="why-card">
                    <i class="bi bi-geo-alt"></i>
                    <h3>Local Service</h3>
                    <p>Quick response from our Boca Raton facility for ongoing service needs.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="cta-section" id="contact">
        <div class="container">
            ...
            <p>Contact us today for a free consultation. We'll work around your patient schedule to deliver hygienic, beautiful surfaces for your healthcare facility.</p>
        ...
        <div class="container">
            <div class="footer-grid">
                <div>
                    ...
                    <p>South Florida's trusted commercial quartz countertop specialists. Serving medical clinics, dental offices, and healthcare facilities throughout Palm Beach, Broward, and Miami-Dade counties.</p>
                </div>
                <div>
