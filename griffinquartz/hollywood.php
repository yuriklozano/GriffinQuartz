...
<head>
    ...
    <meta name="description" content="Quartz countertop installation in Hollywood, FL. Premium quartz surfaces for Hollywood Beach homes and businesses. Free estimates from Griffin Quartz.">
    <title>Quartz Countertops Hollywood FL | Expert Installation | Griffin Quartz</title>
...
<body>
    ...
    <section class="hero hero-small">
        ...
        <div class="hero-content">
            <h1>Quartz Countertops in Hollywood, FL</h1>
            <p class="hero-description">Premium quartz for Hollywood Beach and beyond</p>
        </div>
    </section>
    ...
    <section class="content-section">
        <div class="container">
            <h2 class="section-title">Hollywood, FL Quartz Countertop Installation</h2>
            <p class="section-description">Hollywood's diverse community and beautiful beaches deserve countertops that match. Griffin Quartz provides Hollywood homeowners with premium quartz surfaces that resist humidity and daily wear while adding elegance to any space.</p>

            <div class="features-grid">
                <div class="feature-card">
                    <h3>Beach Community Experts</h3>
                    <p>Experienced with Hollywood Beach condos and homes. Our quartz surfaces resist salt air and humidity while maintaining their beauty.</p>
                </div>
                <div class="feature-card">
                    <h3>Affordable Luxury</h3>
                    <p>Premium quartz countertops at competitive prices. We work with Hollywood homeowners on budgets of all sizes.</p>
                </div>
                <div class="feature-card">
                    <h3>Fast Service</h3>
                    <p>Quick turnaround times for Hollywood installations. Most projects completed within 1-2 weeks.</p>
                </div>
                <div class="feature-card">
                    <h3>Full Service</h3>
                    <p>From consultation to installation, we handle everything for a stress-free experience.</p>
                </div>
            </div>

            <h2 class="section-title" style="margin-top: 60px;">Serving Hollywood Areas</h2>
            <p class="section-description">We install quartz countertops throughout Hollywood including Hollywood Beach, Downtown Hollywood, Emerald Hills, Hollywood Lakes, and all surrounding neighborhoods.</p>

            <div class="cta-section">
                <h3>Transform Your Hollywood Home</h3>
