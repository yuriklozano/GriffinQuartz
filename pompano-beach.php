...
<head>
    ...
    <meta name="description" content="Quartz countertop installation in Pompano Beach, FL. Quality quartz surfaces for homes and businesses. Free estimates from Griffin Quartz.">
    <title>Quartz Countertops Pompano Beach FL | Installation Services | Griffin Quartz</title>
...
<body class="location-page">
    ...
    <section class="hero hero-small">
        ...
        <div class="hero-content">
            <h1>Quartz Countertops in Pompano Beach, FL</h1>
            <p class="hero-description">Quality quartz for Pompano Beach homes</p>
        </div>
    </section>
    ...
    <section class="content-section">
        <div class="container">
            <h2 class="section-title">Pompano Beach Quartz Countertop Services</h2>
            <p class="section-description">Pompano Beach homeowners trust Griffin Quartz for beautiful, durable countertops. Located conveniently between our Boca Raton showroom and Fort Lauderdale, Pompano Beach residents enjoy quick service and easy access to our full quartz selection.</p>

            <div class="features-grid">
                <div class="feature-card">
                    <h3>Convenient Location</h3>
                    <p>Pompano Beach is close to our Boca Raton showroom. Easy access to see and select your perfect quartz countertop.</p>
                </div>
                <div class="feature-card">
                    <h3>Coastal Living Experts</h3>
                    <p>Our quartz surfaces are ideal for Pompano Beach's coastal environment—resistant to humidity, salt air, and daily use.</p>
                </div>
                <div class="feature-card">
                    <h3>Value Pricing</h3>
                    <p>Competitive prices on premium quartz. We work with homeowners on budgets of all sizes.</p>
                </div>
                <div class="feature-card">
                    <h3>Quick Installation</h3>
                    <p>Fast turnaround for Pompano Beach projects. Most installations completed within 1-2 weeks.</p>
                </div>
            </div>

            <h2 class="section-title" style="margin-top: 60px;">Serving Pompano Beach Areas</h2>
            <p class="section-description">We install quartz countertops throughout Pompano Beach including Pompano Beach Highlands, Palm Aire, Cypress Bend, Lighthouse Point, and all surrounding neighborhoods.</p>

            <div class="cta-section">
                <h3>Upgrade Your Pompano Beach Home</h3>
