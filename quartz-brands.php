...
<head>
    ...
    <style>
        ...
        *:focus-visible {
        ...
        .brands-hero .hero-background img {
            width: 100%;
            height: 100%;
            object-fit: cover;
            opacity: 0.5;
        ...
        .why-quartz-icon {
            width: 60px;
            height: 60px;
            background: linear-gradient(135deg, var(--color-accent), #e5a617);
            border-radius: 50%;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .brand-card-compact-header .brand-origin {
            font-size: 0.8125rem;
            color: var(--color-accent);
            margin-top: 0.25rem;
        }

        .brand-card-compact p {
            font-size: 0.9375rem;
            color: var(--color-gray);
            line-height: 1.7;
        }
        ...
        .style-categories-section .container {
            max-width: 1200px;
            margin: 0 auto;
            padding: 0 1.5rem;
        }

        .style-categories-section .section-title {
            color: #fff;
        }

        .style-categories-section .section-description {
            color: rgba(255, 255, 255, 0.7);
        }
        ...
        .style-category-card:hover .card-bg {
            transform: scale(1.1);
        }

        .style-category-card .card-overlay {
            position: absolute;
            inset: 0;
            background: linear-gradient(to top, rgba(0, 0, 0, 0.85) 0%, rgba(0, 0, 0, 0.2) 100%);
        }

        .style-category-card .card-content {
            position: absolute;
            bottom: 0;
            left: 0;
            right: 0;
        ...
        .showroom-cta-section .container {
            max-width: 1000px;
            margin: 0 auto;
            padding: 0 1.5rem;
        }
        ...
        <div class="container">
            ...
            <nav class="nav" id="mainNav">
                <ul class="nav-list">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link">Quartz Brands</a>
                        <ul class="dropdown-menu">
                            <li><a href="cambria/">Cambria</a></li>
                            <li><a href="quartz-brands#silestone">Silestone</a></li>
                            <li><a href="quartz-brands#caesarstone">Caesarstone</a></li>
                            <li><a href="quartz-brands#all-brands">All Brands</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
