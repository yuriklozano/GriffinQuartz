...
<head>
    ...
    <meta name="description" content="Quartz countertop installation in Delray Beach, FL. Quality quartz surfaces for homes and businesses on Atlantic Avenue and beyond. Free estimates from Griffin Quartz.">
    <title>Quartz Countertops Delray Beach FL | Installation Services | Griffin Quartz</title>
...
<body>
    ...
    <section class="hero hero-small">
        ...
        <div class="hero-content">
            <h1>Quartz Countertops in Delray Beach, FL</h1>
            <p class="hero-description">Quality quartz for Florida's Village by the Sea</p>
        </div>
    </section>
    ...
    <section class="content-section">
        <div class="container">
            <h2 class="section-title">Delray Beach Quartz Countertop Services</h2>
            <p class="section-description">Delray Beach's vibrant community deserves beautiful homes with stunning countertops. Griffin Quartz serves Delray Beach homeowners with premium quartz surfaces that enhance kitchens, bathrooms, and living spaces. Our showroom is just minutes away in Boca Raton.</p>

            <div class="features-grid">
                <div class="feature-card">
                    <h3>Close to Our Showroom</h3>
                    <p>Located just minutes from Delray Beach, visit our Boca Raton showroom to see our full quartz selection in person.</p>
                </div>
                <div class="feature-card">
                    <h3>Residential Specialists</h3>
                    <p>From beachside condos to golf course homes, we provide quartz countertops for all types of Delray Beach residences.</p>
                </div>
                <div class="feature-card">
                    <h3>Atlantic Avenue Businesses</h3>
                    <p>Serving Delray Beach's thriving downtown business district with commercial quartz installations.</p>
                </div>
                <div class="feature-card">
                    <h3>Local Expertise</h3>
                    <p>We know Delray Beach and understand the local market. Personalized service with small-town attention.</p>
                </div>
            </div>

            <h2 class="section-title" style="margin-top: 60px;">Serving Delray Beach Areas</h2>
            <p class="section-description">We install quartz countertops throughout Delray Beach including Downtown, Marina District, Tropic Isle, Lake Ida, Seagate, and all surrounding neighborhoods.</p>

            <div class="cta-section">
                <h3>Upgrade Your Delray Beach Home</h3>
